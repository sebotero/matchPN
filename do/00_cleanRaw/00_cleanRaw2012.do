...
use "${path}/src/2012/toClean/PN_2012_toClean.dta", clear
...
replace `nom'=subinstr(`nom',"(SANTO)","",.)
replace `nom'=subinstr(`nom',".","",.)
...
replace `nom'=subinstr(`nom',"GARCëA","GARCIA",.)
replace `nom'=subinstr(`nom',"DÕ LOS SANTOS","DE LOS SANTOS",.)
replace `nom'=subinstr(`nom',"ROODMAèLLE","ROODMALLE",.)
replace `nom'=subinstr(`nom',"ANGEL FRANCISCO(DUPLICADO)","ANGEL FRANCISCO",.)
replace `nom'=subinstr(`nom',"D…RR","DORR",.)
replace `nom'=subinstr(`nom',"«"," ",.)
replace `nom'=subinstr(`nom',"+","",.)
replace `nom'=subinstr(`nom',";","",.)
replace `nom'=subinstr(`nom',":"," ",.)
...
save "${path}/src/2012/PN_2012.dta", replace
